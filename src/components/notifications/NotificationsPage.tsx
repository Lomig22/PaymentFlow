        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-sm ${
              selectedIds.length > 0 ? "bg-red-600 text-white hover:bg-red-700" : "bg-gray-100 text-gray-400 cursor-not-allowed"
            }`}
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-sm ${
              unreadCount > 0 ? "bg-blue-600 text-white hover:bg-blue-700" : "bg-gray-100 text-gray-400 cursor-not-allowed"
            }`}
          >
