      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                autoFocus
              />
              <button className="absolute right-2 top-2 bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-full transition-colors duration-300">
                Rechercher
              </button>
            </div>
          </motion.div>
          ...
          >
            ...
            <a href="#" className="bg-blue-500 hover:bg-blue-700 px-3 py-1 rounded-full transition-colors">
