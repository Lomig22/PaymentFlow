     ...
     <div style="max-width:520px;margin:0 auto;background:white;border-radius:18px;padding:32px 24px;box-shadow:0 8px 24px rgba(80,80,180,0.08);">
      ...
      <div style="margin:1.5em 0 2.5em;">
        <p style="font-size:1.05em;color:#334155;margin:0 0 12px;">
          Votre avis nous aide à améliorer PaymentFlow. Dites-nous ce que vous attendez de l’outil 👇
        </p>
        <a href="https://tally.so/r/mZg9vB" target="_blank" rel="noopener noreferrer" style="display:inline-block;padding:12px 24px;background:#059669;color:white;border-radius:8px;font-size:1em;text-decoration:none;font-weight:700;box-shadow:0 2px 8px rgba(5,150,105,0.2);transition:background 0.2s;">
          Donner mon feedback
        </a>
      </div>
