        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {sectorBlogs.map((sector, idx) => (
            <div key={idx} className="p-6 bg-white rounded-xl shadow-md flex flex-col justify-between">
              ...
              <a href={"/blog" + sector.link} className="mt-4 inline-block px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-700 font-semibold text-center">Voir les cas clients</a>
            </div>
          ))}
        </div>
